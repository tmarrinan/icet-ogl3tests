...
ifeq ($(DETECTED_OS),Windows)
	...
	LIB= -L"$(MPI_LIB)" -L"$(HOMEPATH)\local\lib" -lmsmpi -lIceTCore -lIceTGL3 -lIceTMPI -lglad -lglad_egl -lfreetype
else ifeq ($(DETECTED_OS),Darwin)
	INC= -I$(HOME)/local/include -I/usr/local/include/freetype2 -I./include
	LIB= -L$(HOME)/local/lib -lIceTCore -lIceTGL3 -lIceTMPI -lglad -lglad_egl -lfreetype
else
	INC= -I$(HOME)/local/include -I$(HOME)/local/include/freetype2 -I/usr/include/freetype2 -I./include
	LIB= -L$(HOME)/local/lib -lGL -lEGL -lIceTCore -lIceTGL3 -lIceTMPI -lglad -lglad_egl -lfreetype -ldl
endif
